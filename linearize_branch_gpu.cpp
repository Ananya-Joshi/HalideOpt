...
// g++ linearize_branch_gpu.cpp -g -I ~/Halide10/include/ -I ~/Halide10/share/Halide/tools/ -L ~/Halide10/lib/ -lHalide `libpng-config --cflags --ldflags` -ljpeg -lpthread -ldl -o linearize_branch_gpu -std=c++11
// LD_LIBRARY_PATH=~/Halide10/lib/ ./linearize_branch_gpu
